...
import iconCart from "../../assets/img/icons/icon-cart-big.svg";
...
const navigation = props => {
  ...
  if (props.signedUser.user != null) {

    usr = "Hello" + " " + props.signedUser.user.username; 
    add = (
    ...
    userProducts = (
      <NavLink
        ...
        to={`/products/user/${localStorage.getItem("user-id")}`}
      >
        My Products
      </NavLink>
    );
